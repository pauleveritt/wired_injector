"""
Test the existing injector.

Functions, classes, nametuples, and dataclasses can all get the
simple injection of a variable annotation.

Dataclasses can get the richer injection via dataclass field
metadata.
"""
...
from wired_injector import Injector, _target_type, TargetType
