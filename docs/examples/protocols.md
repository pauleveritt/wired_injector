...
What could tooling, like IDEs, do better?

What Could We Do
- Support some kind of way e.g. @adherent to state implements and warn, without a usage e.g. in a test
- Better enforcement
- Better error messages
- Refactor (like WebStorm TS extract interface)
- And then, navigate from protocols to implementations
